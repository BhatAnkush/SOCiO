        ...
        <Layout>
            ...
            <div className="flex justify-center">
                <div className="w-10/12 p-6">
                    <img loading='lazy' src={blog.image} alt="blog" />
                    ...
                    <div className="mt-2">
                        <h1 className="text-2xl text-gray-700 font-bold hover:underline capitalize">
                            {blog.title}
                        </h1>
                        <p className="mt-2 text-gray-600">{blog.description}</p>
                    </div>
                    {/* User actions: edit and delete if the blog owner is the logged-in user */}
