  ...
  return (
    <Layout>
      <div className="flex justify-center flex-col items-center py-32 bg-gray-100">
        ...
        <Link to="/" className="inline-block mt-8 rounded-md shadow px-5 py-4 bg-violet-500 text-white uppercase tracking-wider font-semibold text-lg">Go back home</Link>
      </div>
    </Layout>
  );
}
